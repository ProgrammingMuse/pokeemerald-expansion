...
static u8 ChooseWildMonIndex_Fishing(u8 rod)
{
    ...
    case OLD_ROD:
        if (rand < ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_0)
            wildMonIndex = 0;
        if (rand < ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_1)
            wildMonIndex = 1;
        if (rand < ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_2)
            wildMonIndex = 2;
        else
            wildMonIndex = 3;
    ...
    case GOOD_ROD:
        ...
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_GOOD_ROD_SLOT_7 && rand < ENCOUNTER_CHANCE_FISHING_MONS_GOOD_ROD_SLOT_8)
            wildMonIndex = 8;
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_GOOD_ROD_SLOT_8 && rand < ENCOUNTER_CHANCE_FISHING_MONS_GOOD_ROD_SLOT_9)
            wildMonIndex = 9;
        ...
        break;
    case SUPER_ROD:
        if (rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_10)
            wildMonIndex = 10;
        ...
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_14 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_15)
            wildMonIndex = 15;
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_15 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_16)
            wildMonIndex = 16;
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_16 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_17)
            wildMonIndex = 17;
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_17 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_18)
            wildMonIndex = 18;
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_18 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_19)
            wildMonIndex = 19;

        if (swap)
            wildMonIndex = 29 - wildMonIndex;
        break;
    }
    return wildMonIndex;
}
